...
dockets_csv_filename="dockets-2024-08-15.csv"
...
originatingcourtinformation_csv_filename="originating-court-information-2024-08-15.csv"
...
fjcintegrateddatabase_csv_filename="fjc-integrated-database-2024-08-15.csv"
...
opinioncluster_csv_filename="opinion-clusters-2024-08-15.csv"

search_opinion_joined_by_fields='(
			id, opinion_id, person_id
)'
search_opinion_joined_by_csv_filename="search_opinion_joined_by-2024-08-15.csv"
...
oralarguments_csv_filename="oral-arguments-2024-08-15.csv"
...
people_db_person_csv_filename="people-db-people-2024-08-15.csv"

# people_db_school
people_db_school_fields='(
	       id, date_created, date_modified, name, ein, is_alias_of_id
	   )'
people_db_school_csv_filename="people-db-schools-2024-08-15.csv"
...
people_db_position_csv_filename="people-db-positions-2024-08-15.csv"
...
people_db_retentionevent_csv_filename="people-db-retention-events-2024-08-15.csv"
...
people_db_education_csv_filename="people-db-educations-2024-08-15.csv"
...
politicalaffiliation_csv_filename="people-db-political-affiliations-2024-08-15.csv"

# people_db_race
people_db_race_fields='(id, race)'
people_db_race_csv_filename="people_db_race-2024-08-15.csv"

# people_db_person_race
people_db_person_race_fields='(
	       id, person_id, race_id
	   )'
people_db_person_race_csv_filename="people-db-races-2024-08-15.csv"


search_opinioncluster_panel_fields='(
	       id, opinioncluster_id, person_id
	   )'
search_opinioncluster_panel_csv_filename="search_opinioncluster_panel-2024-08-15.csv"


search_opinioncluster_non_participating_judges_fields='(
	       id, opinioncluster_id, person_id
	   )'
search_opinioncluster_non_participating_judges_csv_filename="search_opinioncluster_non_participating_judges-2024-08-15.csv"
...
financialdisclosure_csv_filename="financial-disclosures-2024-08-15.csv"
...
investment_csv_filename="financial-disclosure-investments-2024-08-15.csv"
...
disclosures_position_csv_filename="financial-disclosures-positions-2024-08-15.csv"
...
disclosures_agreement_csv_filename="financial-disclosures-agreements-2024-08-15.csv"
...
noninvestmentincome_csv_filename="financial-disclosures-non-investment-income-2024-08-15.csv"
...
spouseincome_csv_filename="financial-disclosures-spousal-income-2024-08-15.csv"
...
disclosures_reimbursement_csv_filename="financial-disclosures-reimbursements-2024-08-15.csv"
...
disclosures_gift_csv_filename="financial-disclosures-gifts-2024-08-15.csv"
...
disclosures_debt_csv_filename="financial-disclosures-debts-2024-08-15.csv"
...
#schema_filename="schema-2024-08-15.sql"
#pg_dump \
#    --host "$DB_HOST" \
#    --username "$DB_USER" \
#    --create \
...
BULK_SCRIPT_FILENAME="load-bulk-data-2024-08-15.sh"
